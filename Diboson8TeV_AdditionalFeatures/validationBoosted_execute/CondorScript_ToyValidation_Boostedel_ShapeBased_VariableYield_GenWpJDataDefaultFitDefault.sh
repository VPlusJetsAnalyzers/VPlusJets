...
#### Run the Toy Fits
echo "electrons, Boosted. Fit the default fit result with the default configuration"
initRand="$(( 4*${Process} + 2800912 ))"
echo "initRand=${initRand}"
CstrNoBtag="runToyMCFits.cc+(${StartToy},${EndToy},4,${initRand},\"Fit_DibosonBoosted_el_log.txt\",\"python -i runDibosonBoosted8TeVFit.py -j 2 --electron -m DibosonBoosted8TeVConfig --runPdfGenToySim --genParamFile DibosonBoostedFitOutPars_el.txt --noNull --nosig\",\"topDibosonBoostedParameters_SidebandModified_el.txt dibosonDibosonBoostedParameters_SidebandModified_el.txt WpJDibosonBoostedParameters_el.txt\",\"./\",\"BoostedFitElectron_ShapeBased_VariableYield_GenWpJDataDefaultFitDefault_\",true,true)"
