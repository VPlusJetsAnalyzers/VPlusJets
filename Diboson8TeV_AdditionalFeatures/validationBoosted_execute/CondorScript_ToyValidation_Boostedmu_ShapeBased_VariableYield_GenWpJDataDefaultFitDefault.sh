...
#### Run the Toy Fits
echo "muons, Boosted. Fit the default fit result with the default configuration"
initRand="$(( 4*${Process} + 28793 ))"
echo "initRand=${initRand}"
CstrNoBtag="runToyMCFits.cc+(${StartToy},${EndToy},4,${initRand},\"Fit_DibosonBoosted_mu_log.txt\",\"python -i runDibosonBoosted8TeVFit.py -j 2 -m DibosonBoosted8TeVConfig --runPdfGenToySim --genParamFile DibosonBoostedFitOutPars_mu.txt --noNull --nosig\",\"topDibosonBoostedParameters_SidebandModified_mu.txt dibosonDibosonBoostedParameters_SidebandModified_mu.txt WpJDibosonBoostedParameters_mu.txt\",\"./\",\"BoostedFitMuon_ShapeBased_VariableYield_GenWpJDataDefaultFitDefault_\",true,true)"
