...
void B_EPJC_72_2046(Int_t Flag = 0){
  ...
  //       (Shows how to de-activate uncertainties)
  //-----------------------------------------------------------------------------
  ...
  TString NamUnc[NumUnc] = {"   Stat", "   Meth", "  MCgen", "    Had", "  Pile", "     UE", 
			    "     CR", "   IFSR", "    PDF", "  Wnorm", "  Wsha", "  Qnorm", 
			    "   Qsha", "   iJES", "    JES", "   bJES", "  btag", "    JER", 
			    "   JEFF", "    MET"};
  ...
  Double_t XEst[LenXEst] = {
    172.93, 1.46, 0.00, 0.07, 0.81, 0.33, 0.05, 0.06, 0.47, 1.45, 0.22, 0.16, 0.11, 0.07, 0.14, 1.21, 1.09, 0.21, 0.34, 0.08,  0.05,
    175.54, 1.13, 0.00, 0.04, 0.69, 0.52, 0.05, 0.10, 0.74, 1.40, 0.09, 0.19, 0.18, 0.05, 0.12, 1.25, 1.21, 0.13, 0.38, 0.11,  0.05,
    174.30, 0.83, 0.59, 0.10, 0.39, 0.20, 0.01, 0.42, 0.32, 1.04, 0.10, 0.34, 0.07, 0.25, 0.38, 0.63, 1.61, 0.31, 0.07, 0.005, 0.12,
    175.01, 0.74, 0.51, 0.03, 0.22, 0.06, 0.01, 0.96, 1.04, 0.95, 0.10, 0.44, 0.22, 0.33, 0.30, 0.71, 1.53, 0.26, 0.07, 0.01,  0.16
  };
  ...
  if(Flag == 0){
    ...
    printf("... B_EPJC_72_2046: Now the 1d(mu) gets more precise than 2d(mu) \n");
    myBlue->PrintResult();
    ...
    myBlue->Solve();
    printf("... B_EPJC_72_2046: mtop(mu) from 1d(mu) and 2d(mu) analyses \n");
    printf("... B_EPJC_72_2046: after also artificially setting rho(JES)=0.5.\n");
    myBlue->PrintResult();
  }
  // Delete Object
  delete myBlue;
