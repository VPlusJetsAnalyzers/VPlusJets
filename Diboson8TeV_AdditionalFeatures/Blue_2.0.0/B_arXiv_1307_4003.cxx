...
void B_arXiv_1307_4003(Int_t Flag = 0){
  ...
  if(Flag == 0){
    ...
    printf("-----------\n");
    printf("... B_arXiv_1307_4003: The two  estimate combination from Table 1,");
    printf(" Flag = %2i \n", Flag);
  }else if(Flag == 1){
    NumEst = NF1Est;
    NumUnc = NF1Unc;
    printf("... B_arXiv_1307_4003: ------------------------------------------");
    printf("------------\n");
    printf("... B_arXiv_1307_4003: The three estimate combination from Table 1,");
    printf(" Flag = %2i \n", Flag);
  }else if(Flag == 2){
    NumEst = NF2Est;
    NumUnc = NF2Unc;
  ...
  if(Flag < 2){
    ...
    if(Flag == 0){
      ...
      printf("... B_arXiv_1307_4003: The combination of A, B1, B2 from Table 1,");
      printf(" Flag = %2i \n", Flag);
    }
