...
void B_ATLAS_CONF_2013_102(Int_t Flag = 0){
  ...
  //     (Shows how to retrieve the Pull information of the result, and how
  //      to use DisplayResult and LatexResult with user defined formats)
  ...
  if(Flag == 0){    
    ...
    myBlue->LatexResult("B_ATLAS_CONF_2013_102",
			ForVal,ForUnc,ForWei,ForRho,ForPul);
    myBlue->DisplayResult(0,"B_ATLAS_CONF_2013_102");
    ...
    printf(" NDof = %2i, Probability = %5.2f %% \n", myBlue->GetNdof(),
	   100*myBlue->GetProb());
    printf("... B_ATLAS_CONF_2013_102: The information weights from Table 2 \n");
    myBlue->PrintInfWei();
