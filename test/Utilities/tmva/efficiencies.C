...
void plot_efficiencies( TString fin, TFile* file, Int_t type = 2, TDirectory* BinDir)
{
   ...
   TString fname = "plots/" +  fin + "_" + hNameRef;
   if (TString(BinDir->GetName()).Contains("multicut")){
...
void efficiencies( TString fin = "/uscms_data/d3/ajay/Higgs125/TMVA/CMSSW_5_3_2_patch4/src/Hwwlnujj/WWlvjj_125TMVAoutput/m125/TMVA_125_nJ2_mu.root", Int_t type = 2, Bool_t useTMVAStyle = kTRUE )
{
   ...
   plot_efficiencies( fin, file, type, gDirectory );
