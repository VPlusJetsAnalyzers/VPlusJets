...
import HWW1D2FitsConfigMoreHigh
import HWW1D2FitsConfigAlt

mu2Pars = dict(HWW1D2FitsConfigMoreHigh.mu2Pars)
for mass in mu2Pars:
    mu2Pars[mass][5]['WpJ'] = HWW1D2FitsConfigAlt.mu2Pars[mass][5]['WpJ']
