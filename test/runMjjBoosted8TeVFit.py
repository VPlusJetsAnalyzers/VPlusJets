...
from ROOT import TCanvas, TLegend, RooFit, RooStats, RooArgSet, RooDataSet, RooLinkedListIter, TMath, RooRandom, TFile, TTree, \
...
## else:
output = TFile("MjjBoostedlnuJ_%s_%ijets_output.root" % (mode, opts.Nj),"recreate")
...
c1.SaveAs("MjjBoostedlnuJ_%s_%ijets_Stacked.png" % (mode, opts.Nj))
c2.SaveAs("MjjBoostedlnuJ_%s_%ijets_Subtracted.png" % (mode, opts.Nj))
cp1.SaveAs("MjjBoostedlnuJ_%s_%ijets_Pull.png" % (mode, opts.Nj))
